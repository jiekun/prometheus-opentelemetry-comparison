...
func (Histogram_ResetHint) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f139519efd9fa8d7, []int{6, 0}
}
...
type Metadata struct {
	Type Metadata_MetricType `protobuf:"varint,1,opt,name=type,proto3,enum=io.prometheus.write.v3Metadata_MetricType" json:"type,omitempty"`
...
type Histogram struct {
	...
	ResetHint      Histogram_ResetHint `protobuf:"varint,14,opt,name=reset_hint,json=resetHint,proto3,enum=io.prometheus.write.v3Histogram_ResetHint" json:"reset_hint,omitempty"`
	// timestamp represents timestamp of the sample in ms.
	//
	// For Go, see github.com/prometheus/prometheus/model/timestamp/timestamp.go
	// for conversion from/to time.Time to Prometheus timestamp.
...
func init() {
	proto.RegisterEnum("io.prometheus.write.v3Metadata_MetricType", Metadata_MetricType_name, Metadata_MetricType_value)
	proto.RegisterEnum("io.prometheus.write.v3Histogram_ResetHint", Histogram_ResetHint_name, Histogram_ResetHint_value)
	proto.RegisterType((*Request)(nil), "io.prometheus.write.v3Request")
	proto.RegisterType((*TimeSeries)(nil), "io.prometheus.write.v3TimeSeries")
	proto.RegisterType((*Label)(nil), "io.prometheus.write.v3Label")
	proto.RegisterType((*Exemplar)(nil), "io.prometheus.write.v3Exemplar")
	proto.RegisterType((*Sample)(nil), "io.prometheus.write.v3Sample")
	proto.RegisterType((*Metadata)(nil), "io.prometheus.write.v3Metadata")
	proto.RegisterType((*Histogram)(nil), "io.prometheus.write.v3Histogram")
	proto.RegisterType((*BucketSpan)(nil), "io.prometheus.write.v3BucketSpan")
}
...
var fileDescriptor_f139519efd9fa8d7 = []byte{
	...
	,
}
